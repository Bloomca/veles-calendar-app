...
const projectAndSections = {
  projects: [
    "Project Waffle Iron",
    "Operation Sofa Sprint",
    "Mission Giggles",
    "Expedition Quirk Quest",
    "Blueprint Banter",
    "Gizmo Gala",
    "Jamboree Juxtaposition",
    "Chronicle of Chaos",
    "Symphony of Syntax",
    "Voyage of the Variables",
  ],
  sections: [
    "Batter Up",
    "Syrup Selection",
    ...
    "Quirk Quotient",
    "Eccentricity Examination",
    "Novelty Notes",
    "Peculiarity Parameters",
    "Uniqueness Unearthed",
    "Rarity Ranking",
    "Singularity Search",
